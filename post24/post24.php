...
class plgVmShipmentpost24 extends vmPSPlugin {
       ...
       function plgVmConfirmedOrder(VirtueMartCart $cart, $order) {
              ...
              $values['selected_parcel'] = $session->get('post24_selected_parcel');
              ...
              $session = JFactory::getSession();
              $session->clear('post24_selected_parcel');
       ...
       function getOrderShipmentHtml($virtuemart_order_id) {
              ...
              $html .= $this->getHtmlRowBE('POST24_TOPHONE', $shipinfo->phone);
              $html .= '</table>'."\n";
              return $html;
       }
       ...
       public function plgVmOnSelectCheckShipment(VirtueMartCart $cart) {
              //get smartpost id
              //$post24_id = JRequest::getVar('virtuemart_shipmentmethod_id');
              $post24_id = JFactory::getApplication()->input->post->get('virtuemart_shipmentmethod_id');
              ...
              //$selected_parcel = JRequest::getVar('sratespost24');
              $selected_parcel = JFactory::getApplication()->input->post->get('sratespost24');
              ...
              $session = JFactory::getSession();
              $session->set('post24_selected_parcel', $selected_parcel);
       ...
       public function plgVmDisplayListFEShipment(VirtueMartCart $cart, $selected = 0, &$htmlIn) {
              ...
              $session = JFactory::getSession();
              $html .= $this->getSelect('sratespost24', $formattedRates, $session->get('post24_selected_parcel'),
       ...
       function _quote($city = '', $state = '') {
             ...
             if ($city === NULL) $city = '';
              ...
              if (file_exists("post24cache.txt") && (time() - filemtime("post24cache.txt")) < 86400) {
                     ...
                     $body = file("https://www.omniva.ee/locations.csv");
                     ...
                     foreach ($body as $bodyElement) {
                            ...
                            if (isset($bodyCsv[2]) && ((int)$bodyCsv[2]) == '1') {
    ...
    public static function sort($a, $b) {
       ...
       //private function csv2array($input,$delimiter=',',$enclosure='"',$escape='\\'){
           ...
           foreach ($fields as $key=>$value)
               $fields[$key]=str_replace('"', '', utf8_decode(str_replace($escape.$enclosure,$enclosure,$value)));
               //$fields[$key]=utf8_decode(str_replace($escape.$enclosure,$enclosure,$value));
           return($fields);
       }
