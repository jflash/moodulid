...
//        echo '<pre>'.htmlspecialchars(print_r($_POST, true), ENT_COMPAT | ENT_HTML401 | ENT_IGNORE).'</pre>';
//        echo '<pre>'.htmlspecialchars(print_r($order, true), ENT_COMPAT | ENT_HTML401 | ENT_IGNORE).'</pre>';
//        echo '<pre>'.htmlspecialchars(print_r($cart, true), ENT_COMPAT | ENT_HTML401 | ENT_IGNORE).'</pre>';
